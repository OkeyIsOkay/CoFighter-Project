...
?>
                                            ...
                                            <form action="{{ url('/CoFighter/super-admin/users/add') }}" method="POST">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <select class="form-select" id="state" name="state" onchange="get_options('center',this.value,'#center')" required>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        ...
                                                        <input type="hidden" class="form-control" value="1" name="rank"/>
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                        <h6 class="mb-0">Admin Previledges</h6>
                                                    </div>
                                                    <div class="col-sm-9 text-secondary">
        ...
        <script>
            ...
            function get_options(route,val,div) {
                var url = "{{url('CoFighter/super-admin')}}";

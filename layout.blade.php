...
<body>
	...
	<div class="wrapper">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                ...
                                                ago
                                                    ...
                                                    <p class="msg-info">If you are going to </p>
                                                </div>
                                            </div>
                                        </a>
                                        <a class="dropdown-item" href="javascript:;">
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="user-info ps-3">
                                <p class="user-name mb-0">{{getUserName()}}</p>
                                <p class="designattion mb-0">{{getUserRank()}}</p>
                            </div>
                        </a>
		...
		<footer class="page-footer">
			<p class="mb-0">&copy; Copyright {{date('Y')}} Ehime. All rights reserved.</p>
		</footer>
	</div>
	<!--end wrapper-->
    ...
    <script>
        ...
        function get_options(route,val,div) {
            var loader = "{{asset('static/img/loader.gif')}}";
            $(div).html('<div id="loader"> <br> <img  src="' + loader + '"></div>');
